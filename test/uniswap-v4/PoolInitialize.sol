...
//
// Uniswap v4-core Pool initialization tier. The AGasTest wrapper is authored
// for this suite; the flattened library bodies below are verbatim sources from
// v4-core commit 46c6834698c48bc4a463a86d8420f4eb1d7f3b75 (only import and
// individual pragma/SPDX lines are removed by flattening).
...
contract AGasTest {
    ...
    function initialize() external returns (int24 tick) {
        return pool.initialize(SQRT_PRICE_1_1, 3000);
    }
...
// ----
// initialize() -> 0
// slot0() -> 79228162514264337593543950336, 0, 0
