...
//
// Uniswap v4-core Pool liquidity tier. The AGasTest wrapper is authored for
// this suite; the flattened library bodies below are verbatim sources from
// v4-core commit 46c6834698c48bc4a463a86d8420f4eb1d7f3b75 (only import and
// individual pragma/SPDX lines are removed by flattening). Calls build on
// persistent state initialized with an in-range position in the constructor.
...
// donate() -> -1000, -2000
// removeLiquidity() -> 2990868880254831, 2990868880254831
// slot0() -> 79228162514264337593543950336, 0, 600000000000000000
