...
-- BEGIN SPEC CLOSURE PIN (generated by scripts/update-spec.sh — do not edit by hand)
/-- info:
SPEC CLOSURE — audited this-repo surface (97 decls)
  ...
  struct YulEvmCompiler.ExternalModel 10fd9bffb845ea09
  struct YulEvmCompiler.ExternalsRealized ebe93d1483edec62
  struct YulEvmCompiler.FrameOK ec23d54b6e97193
  struct YulEvmCompiler.GasCallKind ce6fdedb5c990d61
  datadef YulEvmCompiler.GasCallKind.op ebc90597166d137a
  datadef YulEvmCompiler.GasCallKind.target 2a1d729b05481ece
  struct YulEvmCompiler.GasCallsRealized ddac257c3e5ec2fa
  struct YulEvmCompiler.GasTx 1ef5340ce9800723
  ...
  datadef YulEvmCompiler.Instr.opByte 161cc516877efa32
  ...
  statement YulEvmCompiler.Optimizer.LocalPass.optimize_then_compile_correct ca06364cd86fad12
  relation YulEvmCompiler.Optimizer.Sound d9d7947b1bb2287
  relation YulEvmCompiler.RunResolvedObject 89c18e71e0b698d9
  ...
  statement YulEvmCompiler.compileObject_correct 312e35bb55a5c0cc
  statement YulEvmCompiler.compile_correct 68f0c53fdb065a6e
  statement YulEvmCompiler.compile_correct_eval 674290481d8d91f2
  statement YulEvmCompiler.compile_correct_withPayload 3730e65a4306017
  ...
  datadef YulEvmCompiler.unpatchedImmutables 4350bdab12d0a1ca
  ...
  relation YulSemantics.EquivBlock 821fd724d2ff58a6
  relation YulSemantics.EquivStmt 495eaf71400d48
external boundary: 159 decls, combined hash 8719a33673df3175
-/
#guard_msgs in
open SpecClosure in
run_cmd do Lean.logInfo (signature (← getEnv))
