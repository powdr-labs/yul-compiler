...
-- BEGIN SPEC CLOSURE PIN (generated by scripts/update-spec.sh — do not edit by hand)
/-- info:
SPEC CLOSURE — audited this-repo surface (99 decls)
  ...
  struct YulEvmCompiler.Optimizer.Pass c7f69430334b5767
  statement YulEvmCompiler.Optimizer.Pass.optimize_then_compile_correct 9308d529c11eeb2b
  relation YulEvmCompiler.Optimizer.ScopedArgs cca42bbbb74d8753
  relation YulEvmCompiler.Optimizer.ScopedCases 1c8b5a7afb2519e7
  relation YulEvmCompiler.Optimizer.ScopedExpr 3195f0a8bbf7c0fc
  relation YulEvmCompiler.Optimizer.ScopedOptBlock 211d23fed52ef94c
  relation YulEvmCompiler.Optimizer.ScopedOptExpr 4a01a17eca926401
  relation YulEvmCompiler.Optimizer.ScopedStmt 4276675c2733cb41
  relation YulEvmCompiler.Optimizer.ScopedStmts 3e6662f7eca887f8
  relation YulEvmCompiler.Optimizer.Sound 967f616639434ee
  relation YulEvmCompiler.Optimizer.WellScoped 546d947c7f457409
  datadef YulEvmCompiler.Optimizer.declVars 2d487d30a9e72858
  datadef YulEvmCompiler.Optimizer.declVarsList a0e799ae40f0bd07
...
external boundary: 153 decls, combined hash 1b72657fa1e8f869
-/
#guard_msgs in
open SpecClosure in
run_cmd do Lean.logInfo (signature (← getEnv))
